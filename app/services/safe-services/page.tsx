...
export const metadata: Metadata = {
  ...
  description:
    'Professional safe and vault services in Kokomo, Indiana. Safe opening without damage, combination changes, digital lock reset, vault repair. Call (855) 633-0750.',
