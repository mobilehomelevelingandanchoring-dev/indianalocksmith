...
export const metadata: Metadata = {
  title: 'Emergency Locksmith Kokomo IN | 24/7 Fast Response | (575) 573-2625',
  description:
    '24/7 emergency locksmith in Kokomo, Indiana. Car lockouts, home lockouts, business lockouts — 15-30 minute response time throughout Howard County. Call (575) 573-2625 now.',
  alternates: { canonical: `${BUSINESS_WEBSITE}/services/emergency-locksmith` },
  openGraph: {
    title: '24/7 Emergency Locksmith Kokomo, IN | Call Now: (575) 573-2625',
