...
export const metadata: Metadata = {
  title: 'Residential Locksmith Kokomo IN | Home Lockouts, Rekeying, Smart Locks | (917) 203-4678',
  description:
    'Residential locksmith services in Kokomo, Indiana. Home lockouts, lock installation, rekeying, deadbolts, smart locks. Licensed, insured, owner-operated. Call (917) 203-4678.',
...
const faqs = [
  ...
  { question: 'What if I\'m locked out of my house at night?', answer: 'Call us any time at (917) 203-4678. We offer 24/7 emergency home lockout service in Kokomo and throughout Howard County. Average response time is 15–30 minutes.' },
];
