...
export const metadata: Metadata = {
  ...
  description:
    `Complete locksmith services in Kokomo, Indiana — automotive lockouts, residential locks, commercial security, emergency service, key programming, and safes. ${BUSINESS_YEARS_EXPERIENCE}+ years experience. Call (917) 203-4678.`,
