...
export const metadata: Metadata = {
  title: 'Automotive Locksmith Kokomo IN | Car Lockout, Key Programming | (575) 573-2625',
  description:
    'Professional automotive locksmith in Kokomo, Indiana. Car lockouts, transponder key programming, key fob replacement, ignition repair. Fast 15-30 min response. Call (575) 573-2625.',
