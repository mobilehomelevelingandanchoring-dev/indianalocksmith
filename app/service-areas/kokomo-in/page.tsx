...
export const metadata: Metadata = {
  title: 'Locksmith in Kokomo Indiana | Locksmiths Kokomo IN | (575) 573-2625',
  description:
    'Searching for locksmiths in Kokomo Indiana? Affordable Locksmith is Kokomo\'s #1 trusted locksmith — car lockouts, home lockouts, rekeying, transponder keys, commercial security, and 24/7 emergency service. Call (575) 573-2625.',
  alternates: { canonical: `${BUSINESS_WEBSITE}/service-areas/kokomo-in` },
  openGraph: {
    title: 'Locksmith in Kokomo Indiana | Locksmiths Kokomo IN | (575) 573-2625',
    description: 'Trusted locksmiths in Kokomo, Indiana. 39+ years experience, 24/7 emergency service, upfront pricing. Call (575) 573-2625.',
  },
};
