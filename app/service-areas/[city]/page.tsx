...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = `Locksmith ${city.name}, ${city.stateShort} | Mobile Locksmith 24/7 | (917) 203-4678`;
  const description = `Looking for a locksmith in ${city.name}, ${city.state}? Affordable Locksmith dispatches from Kokomo — ${city.distanceMiles} miles away, ~${city.distanceMiles + 10}–${city.distanceMiles + 25} min response. Car lockouts, home lockouts, key programming, 24/7 emergency. Call (917) 203-4678.`;
  ...
  return {
    ...
    openGraph: {
      ...
      description: `Mobile locksmith serving ${city.name}, ${city.state}. Fast response, honest pricing, 24/7 emergency service. Call (917) 203-4678.`,
      url: canonical,
      type: 'website',
    },
    twitter: {
...
function buildCityFAQs(city: City) {
  ...
  return [
    ...
    },
    {
      ...
      answer: `Yes. Affordable Locksmith responds to emergencies in ${city.name} around the clock — including late nights, weekends, and holidays. Call (917) 203-4678 any time. We give you an honest arrival estimate (typically ${arrivalMin}–${arrivalMax} minutes) and confirm pricing before dispatching.`,
    },
    {
    ...
    },
    {
      ...
      answer: `Yes. While our dispatch base is in Kokomo, we regularly serve all of ${city.county} including ${city.name} and surrounding communities. Call (917) 203-4678 — we confirm we can reach you and provide an honest arrival estimate before you commit to anything.`,
    },
  ];
}
