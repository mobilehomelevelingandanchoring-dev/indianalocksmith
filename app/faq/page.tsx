...
export const metadata: Metadata = {
  title: 'Locksmith FAQ Kokomo Indiana | Costs, Services & Scam Tips | (917) 203-4678',
  description:
...
const allFaqs = [
  ...
  { question: 'Which locksmith is open now in Kokomo?', answer: 'Affordable Locksmith is open right now — 24 hours a day, 7 days a week. Call (917) 203-4678 and a real person will answer immediately, any time of day or night.' },
  // Smart Locks
          ...
          <div className="max-w-3xl mt-4">
            ...
            <div className="bg-white/10 border border-white/20 rounded-2xl p-6 mb-6">
              ...
              <p className="text-blue-50 text-lg leading-relaxed speakable-summary">
                A locksmith in Kokomo Indiana typically costs $45–$150. Emergency service is available 24/7 with 15–30 minute response. Car lockouts start at $45, rekeying starts at $25 per lock, and transponder keys start at $75 — all significantly less than dealership pricing. Call <strong>(917) 203-4678</strong> any time.
              </p>
            </div>
